...
resultsfolder = "/data/cbig/I-SPY2/shared/Check_anderson_ksamp/manufacturer_v02/"
...
for datfile in datfile_T0:
    ...
    for current_key in feature_list:
        ...
        row = {'Feature': current_key, 'Statistics': res.statistic, 'p-value': res.pvalue,'Statistics-withPhilipsHealthcare':res_4sample.statistic, 'p-value-withPhilipsHealthcare': res_4sample.pvalue, 'critical-25%': res.critical_values[0], 'critical-10%': res.critical_values[1], 'critical-5%': res.critical_values[2], 'critical-2.5%': res.critical_values[3], 'critical-1%': res.critical_values[4], 'critical-0.5%': res.critical_values[5], 'critical-0.1%': res.critical_values[6]}
