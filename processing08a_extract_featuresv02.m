...
input_maps_dirname = '/data/cbig/I-SPY2/shared/kineticmaps_resampled_registered_affinecorrected_withftv_v02/';
input_maps_dirname_withoutftv = '/data/cbig/I-SPY2/shared/kineticmaps_resampled_registered_withoutftv_v02/';
output_dir_name = '/data/cbig/I-SPY2/shared/features_kineticmaps_v02/';
output_dir_name_witoutftv = '/data/cbig/I-SPY2/shared/features_kineticmaps_withoutftv_v02/';
output_dir_name_compiled = '/data/cbig/I-SPY2/shared/features_kineticmaps_compiled_v02/';
...
list_lab_inputv01 = "post_kineticmaps_v02";
list_lab_inputv02 = "post_kineticmaps_noftv_v02";
list_lab_outputv01 = "feature_files_v02";
list_lab_outputv02 = "feature_files_noftv_v02"
list_lab_mask = "post_registration_affine_ftv_dilateerode";
list_lab_outputcompiledv01 = "feature_files_compiled_v02";
list_lab_outputcompiledv02 = "feature_files_noftv_compiled_v02";
...
for pt = 1:num_patients
    ...
    for tp = 1:length(timepoints)
        for kin = 1:length(name_kinmaps)
            input_pathv01 = fullfile(input_maps_dirname, pt_id_info(pt), timepoints(tp) + "_" + name_kinmaps(kin)) + ".nii.gz";
            fprintf(fileinputv01, '%s\n', input_pathv01);
            output_pathv01 = fullfile(output_dir_name, pt_id_info(pt), timepoints(tp) + "_" + name_kinmaps(kin) + ".csv");
            fprintf(fileoutputv01, '%s\n', output_pathv01);
            input_pathv02 = fullfile(input_maps_dirname_withoutftv, pt_id_info(pt), timepoints(tp) + "_" + name_kinmaps(kin)) + ".nii.gz";
            fprintf(fileinputv02, '%s\n', input_pathv02);
            output_pathv02 = fullfile(output_dir_name_witoutftv, pt_id_info(pt), timepoints(tp) + "_" + name_kinmaps(kin) + ".csv");
