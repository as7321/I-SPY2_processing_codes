...
input_mask_dir_name = '/data/cbig/I-SPY2/shared/post_registration_affine_ftv_dilateerode/'
output_dir_name = '/data/cbig/I-SPY2/shared/kineticmaps_resampled_registered_affinecorrected_withftv_v02/' #With FTV
#output_dir_name = '/data/cbig/I-SPY2/shared/kineticmaps_resampled_registered_withoutftv_v02/' #Without FTV
