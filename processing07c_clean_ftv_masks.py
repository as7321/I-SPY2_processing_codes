...
input_ftv_mask_dir = '/data/cbig/I-SPY2/shared/ftv_resample_regis_affine_binary/'
output_ftv_mask_dir = '/data/cbig/I-SPY2/shared/ftv_resample_regis_affine_binary_eroded/'
timepoints = ['T0', 'T1']
...
count = 1
for pt in ptnames:
    print("Processing " + str(count) + " out of 1554 cases")
    ...
    for tp in timepoints:
        ...
        ftv_new = nib.Nifti1Image(mask_dilated, affine)
