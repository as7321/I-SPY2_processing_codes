...
#input_ftv_dir_name = '/data/cbig/I-SPY2/shared/ftv_resample_regis_affinecorrected/'
...
processed_ftv_vol_dirname = os.path.join(processed_excel_dirname, 'ftv_volume')
...
def ld(nii):
    ...
    if data.sum() > 8: # at lease 8 voxel to have contour after erosion
