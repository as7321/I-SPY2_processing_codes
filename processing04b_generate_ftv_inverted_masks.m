...
output_dir_name_v01 = "/data/cbig/I-SPY2/shared/pre_resampling_ftv_inverted/"
output_dir_name_v02 = "/data/cbig/I-SPY2/shared/post_resampling_ftv_inverted/"
...
for i = 1:num_files
    ...
    file_path_current = strrep(file_path_prev, 'post_resampling', 'post_resampling_ftv_inverted');
    file_path_between = strrep(file_path_prev, 'post_resampling', 'pre_resampling_ftv_inverted');
