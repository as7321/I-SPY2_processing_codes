...
resultpath = "/groups/dk3360_gp/projects/I-SPY2/shared/features_harmonized_v03b/"
...
for tp in timepoints:
    sheetname_batch = tp + "_batch_effects_v02" #"_batch_effects" if only want to include manufacturer and field strength, "_v02" includes pixdim_z also
    ...
    batch_df["pixdim_z"] = (batch_df["pixdim_z"] <= 1.5).astype(int)
    ...
    #combine the clinical covars and batch effects into one dataframe called 'covars' -Modify when HR/HER2 effects need not be adjusted
    ...
    for kinmap in kin_maps:
        ...
        print(covars['pixdim_z'].value_counts())
